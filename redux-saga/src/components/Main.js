  ...
  return (
    <div className='container-fluid bg-white'>
      <div className='row'>
        ...
        <div className='col-lg-2'><Button endIcon={<DeleteTwoTone />} className='mt-4' color="error" variant="contained" onClick={() => dispatch(emptyCart())}>Empty Cart</Button></div>
      </div>
      <div className='row mt-3'>
        {
          ...
          data.map((item)=><div className='col-lg-2 col-md-3 items'>
            ...
            <div><br />
              <Button endIcon={<AddShoppingCartTwoTone />} variant="contained" onClick={() => dispatch(addToCart(item))} >Add to Cart</Button><br /><br />
              <Button endIcon={<RemoveShoppingCartTwoTone />} variant="contained" onClick={() => dispatch(removeToCart(item.id))}>Remove to Cart</Button><br /><br />
              </div>
          </div>):
